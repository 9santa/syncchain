...
const (
	Account_AccountCreate_FullMethodName  = "/rpc.Account/AccountCreate"
	Account_AccountBalance_FullMethodName = "/rpc.Account/AccountBalance"
)
...
func (UnimplementedAccountServer) AccountCreate(context.Context, *AccountCreateReq) (*AccountCreateRes, error) {
	return nil, status.Error(codes.Unimplemented, "method AccountCreate not implemented")
}
func (UnimplementedAccountServer) AccountBalance(context.Context, *AccountBalanceReq) (*AccountBalanceRes, error) {
	return nil, status.Error(codes.Unimplemented, "method AccountBalance not implemented")
}
